...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, SweepStakesDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | SweepStakesDayData): ChartEntry => ({
