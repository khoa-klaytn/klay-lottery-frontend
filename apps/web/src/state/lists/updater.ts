import { getVersionUpgrade, VersionUpgrade } from '@sweepstakes/token-lists'
import { acceptListUpdate, updateListVersion, useFetchListCallback } from '@sweepstakes/token-lists/react'
