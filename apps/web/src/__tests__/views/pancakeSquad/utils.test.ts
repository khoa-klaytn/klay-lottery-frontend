...
import { getAltText, getEventStepStatus, getEventText } from 'views/SweepStakesSquad/utils'

const HOUR_IN_MS = 3600 * 1000

describe('SweepStakesSquad/utils/getEventStepStatus', () => {
...
describe('SweepStakesSquad/utils/getEventText', () => {
  it('Should return past status', () => {
    // Given
    const eventStatus = [SaleStatusEnum.Presale, SaleStatusEnum.Sale]
    const saleStatus = SaleStatusEnum.Claim
...
describe('SweepStakesSquad/utils/getAltText', () => {
