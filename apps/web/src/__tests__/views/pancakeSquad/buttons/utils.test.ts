import { BuyButtonsEnum } from 'views/SweepStakesSquad/components/Buttons/types'
import { getBuyButton, getBuyButtonText } from 'views/SweepStakesSquad/components/Buttons/utils'
import { SaleStatusEnum } from 'views/SweepStakesSquad/types'

describe('SweepStakesSquad/buttons/utils/getBuyButtonText', () => {
...
describe('SweepStakesSquad/buttons/utils/getBuyButton', () => {
