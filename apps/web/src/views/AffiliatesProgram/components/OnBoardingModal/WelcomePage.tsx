import { Flex, Box, Text, Button, LogoRoundIcon, Checkbox, Link } from '@sweepstakes/uikit'
    ...
    <Flex flexDirection="column" padding={['24px', '24px', '24px', '24px', '50px 24px']}>
      ...
      <Box>
        ...
        <Text color="textSubtle" fontSize="14px" mb="24px">
          {t('has referred you to start trading on SweepStakes')}
        </Text>
