        ...
        <Box>
          <Text>
            {isBoostingExpired
              ...
              : t(
                  'Voting power is calculated using the staking amount and remaining staking duration of the fixed-term KLAY staking position at the block.',
                )}
          </Text>
          <Text bold m="10px 0">
            {`${t('KLAY locked:')} ${formatNumber(lockedCakeBalance, 0, 2)}`}
          </Text>
  ...
  return (
    <ModalInner mb="0">
      <Text as="p" mb="24px" fontSize="14px" color="textSubtle">
        {t(
          'Your voting power is determined by the amount of KLAY you held and the remaining duration on the fixed-term staking position (if you have one) at the block detailed below. KLAY held in other places does not contribute to your voting power.',
        )}
      </Text>
