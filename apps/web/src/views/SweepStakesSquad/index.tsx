...
import SweepStakesSquadHeader from './components/Header'
import { SweepStakesSquadContext } from './context'
...
const SweepStakesSquad: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <SweepStakesSquadContext.Provider value={{ isUserEnabled, setIsUserEnabled }}>
      <StyledSquadContainer>
        <SweepStakesSquadHeader
          account={account}
          isLoading={isLoading}
          userInfos={userInfos}
    ...
    </SweepStakesSquadContext.Provider>
  )
}
