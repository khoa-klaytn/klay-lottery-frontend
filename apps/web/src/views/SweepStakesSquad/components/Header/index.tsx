...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@sweepstakes/uikit'
import { useTranslation } from '@sweepstakes/localization'
import { useBSCCakeBalance } from 'hooks/useTokenBalance'
import useTheme from 'hooks/useTheme'
import { StyledWaveContainer } from 'views/SweepStakesSquad/styles'
...
import { SweepStakesSquadHeaderType } from './types'

const DEFAULT_CAKE_COST = 15
const DEFAULT_MAX_TICKETS = 10

const SweepStakesSquadHeader: React.FC<React.PropsWithChildren<SweepStakesSquadHeaderType>> = ({
  userInfos,
  eventInfos,
  account,
  userStatus,
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('SweepStakes’s first official generative NFT collection.')}
      </Text>
...
export default SweepStakesSquadHeader
