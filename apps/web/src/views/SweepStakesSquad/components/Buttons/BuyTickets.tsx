...
import { Button, useModal, useToast } from '@sweepstakes/uikit'
...
import { SweepStakesSquadContext } from 'views/SweepStakesSquad/context'
...
const BuyTicketsButtons: React.FC<React.PropsWithChildren<BuyTicketsProps>> = ({
  ...
  const { isUserEnabled, setIsUserEnabled } = useContext(SweepStakesSquadContext)
  ...
  const [onPresentEnableModal, onDismissEnableModal] = useModal(
    <ConfirmModal
      ...
      loadingText={t('Please enable KLAY spending in your wallet')}
