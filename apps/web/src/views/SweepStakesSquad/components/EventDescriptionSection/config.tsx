...
const eventDescriptionConfigBuilder = ({ t }: EventDescriptionType) => ({
  ...
  subHeadingText: t(
    'All SweepStakes Squad NFTs are allocated to Squad Ticket holders through a provably-fair system based on ChainLink at the time of minting.',
  ),
  ...
  bodyText: [
    {
      id: 1,
      content: (
        <>{t('490 are available in the pre-sale for owners of Gen 0 SweepStakes Bunnies (bunnyID 0, 1, 2, 3, 4)')}</>
      ),
    },
  ...
  primaryButton: {
    to: 'https://docs.sweepstakes.finance/',
