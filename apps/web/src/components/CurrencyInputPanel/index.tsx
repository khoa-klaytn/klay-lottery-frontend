...
import { Currency, Pair, Token, Percent, CurrencyAmount } from '@sweepstakes/sdk'
import { Button, Text, useModal, Flex, Box, CopyButton, Loading, Skeleton, ArrowDropDownIcon } from '@sweepstakes/uikit'
import { Swap as SwapUI } from '@sweepstakes/widgets-internal'
import { styled } from 'styled-components'
import { isAddress } from 'utils'
import { useTranslation } from '@sweepstakes/localization'
import { WrappedTokenInfo } from '@sweepstakes/token-lists'
import { formatAmount } from '@sweepstakes/utils/formatFractions'
