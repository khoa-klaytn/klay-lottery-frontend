...
import { Text, Flex, Box, CloseIcon, IconButton, useMatchBreakpoints } from '@sweepstakes/uikit'
...
const domain = 'https://sweepstakes.finance'
...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    ...
    return warningText.split(/(https:\/\/sweepstakes.finance)/g)
  }, [t])
