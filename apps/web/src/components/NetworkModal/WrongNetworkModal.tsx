...
import { ArrowForwardIcon, Button, Grid, Message, MessageText, Modal, Text, FlexGap } from '@sweepstakes/uikit'
...
export function WrongNetworkModal({ currentChain, onDismiss }: { currentChain: Chain; onDismiss: () => void }) {
  ...
  return (
    <Modal title={t('You are in the wrong network')} headerBackground="gradientCardHeader" onDismiss={onDismiss}>
