...
const UsAgreement = () => {
  return (
    <AffiliatesProgramLayout>
      <Container>
        <Text as="h1">SweepStakes Affiliate Program Agreement</Text>
        <Text as="h3">Last modified: Sep 1, 2023</Text>
        <Text as="p">
          This SweepStakes Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you (“
          <strong>Affiliate”</strong>) and SweepStakes that applies to your participation in the SweepStakes Affiliate
          Program (“Program”). In this Agreement, “<strong>SweepStakes</strong>,” “<strong>we</strong>” or “
          <strong>us</strong>” means SweepStakes. If you are participating or registering on behalf of a business, then
          ...
          web page), you agree to this Agreement which may be amended from time to time by SweepStakes.
        </Text>
        ...
        <Text as="p">
          ...
          users (“<strong>Referrals”</strong>) to register and trade on SweepStakes, in accordance with the terms of
          this Agreement.
        </Text>
        <Text as="p">
          1.2 A Referral must be a new user and must not have interacted or signed with the SweepStakes platform or used
          any of SweepStakes’s services (including but not limited to V2, V3 swapping services, perpetual trading,
          Non-Fungible Tokens and related services, initial farm offerings and similar offerings) (“SweepStakes
          Services”).
        </Text>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on SweepStakes V2 and SweepStakes V3, limited
        ...
        <Text as="p">
          ...
          <Text as="p">
            ...
            <Link href="https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-extended.json">
              https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-extended.json
            </Link>
          </Text>
          <Text as="p">
            Arbitrum One:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-arbitrum-default.json">
              https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-arbitrum-default.json
            </Link>
          </Text>
          <Text as="p">
            Base:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-base-default.json">
              https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-base-default.json
            </Link>
          </Text>
          <Text as="p">
            Ethereum:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-eth-default.json">
              https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-eth-default.json
            </Link>
          </Text>
          <Text as="p">
            Linea:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-linea-default.json">
              https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-linea-default.json
            </Link>
          </Text>
          <Text as="p">
            Polygon zkEVM:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-polygon-zkevm-default.json">
              https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-polygon-zkevm-default.json
            </Link>
          </Text>
          <Text as="p">
            zkSync Era:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-zksync-default.json">
              https://tokenlists.org/token-list?url=https://tokens.sweepstakes.finance/sweepstakes-zksync-default.json
            </Link>
          </Text>
        ...
        <Text as="p">3.2 All commissions will be paid out in KLAY tokens.</Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          3.3(a) , we will calculate your commissions in KLAY tokens using the prevailing USD price of KLAY tokens at
          that time.
        </Text>
        <Text as="p">3.4 In calculating your commissions, we reserve the right to determine the:</Text>
        <Text as="p">
          (a) prevailing USD price of the Trading Fees Denomination and the KLAY tokens by reference to the spot price
        ...
        <Text as="p">
          7.3 Any statements you make about SweepStakes must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">You warrant, represent, and undertake to SweepStakes that:</Text>
        ...
        <Text as="p">
          ...
          not that of employer and employee. You will not be treated as an employee of SweepStakes for any purpose.
          ...
          offers or representations on behalf of SweepStakes. You shall have no authority to bind SweepStakes, and
          undertake not to hold yourself out as an employee, agent or authorised representative of SweepStakes.
        </Text>

        <Text as="h3">12. No Joint Publicity</Text>
        <Text as="p">
          You may not claim that any materials are created jointly between you and SweepStakes, or attribute any
          materials created or issued by you (including press releases) to SweepStakes.
        </Text>

        <Text as="h3">13. Term and Termination</Text>
        <Text as="p">
          13.1 SweepStakes reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the SweepStakes website
          and all images of SweepStakes and other materials provided under the Program.
        </Text>
        <Text as="p">
          13.2 SweepStakes, in its sole discretion, reserves the right to suspend or terminate your account and refuse
          any and all current or future use of the Program, or any other SweepStakes service, for any reason and at any
          time. Such termination will result in the deactivation or deletion of your Affiliate Account.
        </Text>
        <Text as="p">13.3 SweepStakes reserves the right to refuse service to anyone for any reason at any time.</Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify SweepStakes from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          SweepStakes and any of SweepStakes&apos;s officers, directors, employees, shareholders or agents of any of
        ...
        <Text as="p">
          ...
          make any price predictions over the KLAY tokens;
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of SweepStakes Services to create new addresses to
          sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any SweepStakes products and services to users in the
        ...
        <Text as="p">
          SweepStakes may provide you with trademarks and/or graphical images that can be used to promote SweepStakes.
          You may not modify these trademarks and/or images in any way. SweepStakes reserves the right to change the
        ...
        <Text as="p">
          ...
          relationship as an Affiliate which is promoting SweepStakes. For example:
        </Text>
        <Text as="p">
          (a) If you promote SweepStakes through a web page, podcast, blog post, or social media post as an endorsement
          or review of SweepStakes or incentivise others to do so, you must ensure that such post includes a clear
          disclosure that it is an advertisement or was otherwise promoted by SweepStakes; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by SweepStakes from time to
