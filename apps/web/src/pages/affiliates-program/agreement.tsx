    ...
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          ...
          Non-Fungible Tokens and related services and offerings) (“SweepStakes Services”).
        </Text>
        ...
        <Text as="p">4.2 All commissions will be paid out in KLAY tokens.</Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          4.3(a) , we will calculate your commissions in KLAY tokens using the prevailing USD price of KLAY tokens at
          that time.
        </Text>
        ...
        <Text as="p">
          8.3 Any statements you make about SweepStakes must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          14.1 SweepStakes reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          14.2 SweepStakes, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">14.3 SweepStakes reserves the right to refuse service to anyone for any reason at any time.</Text>
