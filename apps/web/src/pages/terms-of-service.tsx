...
import { Flex, Text, Link } from '@sweepstakes/uikit'
...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">SweepStakes Terms of Service</Text>
      ...
      <Text as="p">
        ...
        <Link m="0 4px" display="inline !important" href="https://sweepstakes.finance">
      ...
      <Text as="p">
        ...
        SweepStakes protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        <Link m="0 4px" display="inline !important" href="https://sweepstakes.finance/terms-of-service">
          https://sweepstakes.finance/terms-of-service.
        </Link>
        <Text as="span">
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. SweepStakes does not control or operate any version of the Protocol on any blockchain
        ...
        SweepStakes team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p">
        SweepStakes owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the SweepStakes default token list and
        SweepStakes expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on SweepStakes.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        modifications to the Protocol are generally managed in a community-driven way by holders of the KLAY token. No
      ...
      <Text as="p">
        ...
        potential dispute arises, you must contact us by sending an email to info@sweepstakes.come so that we can
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by SweepStakes, you will be solely responsible to
