...
import { AutoColumn, KnownPlaceholderIcon, ChartDisableIcon, LineGraphIcon } from "@sweepstakes/uikit";
...
export function LiquidityChartRangeInput({
  ...
  return (
    <AutoColumn gap="md" style={{ minHeight: "200px", width: "100%", marginBottom: "16px" }}>
      {isUninitialized ? (
        <InfoBox message={t("Your position will appear here.")} icon={<KnownPlaceholderIcon />} />
      ) : isLoading ? (
