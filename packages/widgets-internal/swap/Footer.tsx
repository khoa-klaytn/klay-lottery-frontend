...
import { LinkExternal, Flex, Svg, Image, Button } from "@sweepstakes/uikit";
...
> = ({
  ...
  externalText,
  externalLinkUrl,
  helpImage = <Image src="https://cdn.sweepstakes.com/help/help.png" alt="Get some help" width={160} height={108} />,
}) => {
