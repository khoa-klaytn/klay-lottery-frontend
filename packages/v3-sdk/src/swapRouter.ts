...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@sweepstakes/sdk'
...
/**
 * Represents the SweepStakes V3 SwapRouter, and has static methods for helping execute trades.
 */
