...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@sweepstakes/swap-sdk-core'
...
/**
 * Represents the SweepStakes V3 QuoterV1 contract with a method for returning the formatted
