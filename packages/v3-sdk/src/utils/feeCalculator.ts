import { Currency, CurrencyAmount, MaxUint256, Percent, Fraction, ZERO } from '@sweepstakes/swap-sdk-core'
import invariant from 'tiny-invariant'
import { parseNumberToFraction } from '@sweepstakes/utils/formatFractions'
