import { TradeType, Token, CurrencyAmount, Currency, Percent } from '@sweepstakes/swap-sdk-core'
...
/**
 * The parameters to use in the call to the SweepStakes Router to execute a trade.
 */
export interface SwapParameters {
  /**
   * The method to call on the SweepStakes Router.
   */
  methodName: string
  /**
...
/**
 * Represents the SweepStakes Router, and has static methods for helping execute trades.
 */
