...
import { scales, SweepStakesToggleProps, HandleProps, InputProps, ScaleKeys } from "./types";
...
const getScale =
  (property: ScaleKeys) =>
  ({ scale = scales.LG }: SweepStakesToggleProps) => {
    return scaleKeyValues[scale][property];
  };

export const SweepStakesStack = styled.div<HandleProps>`
  position: relative;
...
export const SweepStakesInput = styled.input<InputProps>`
  height: 40px;
  left: 0;
  opacity: 0;
  position: absolute;
...
export const SweepStakesLabel = styled.label<SweepStakesToggleProps>`
